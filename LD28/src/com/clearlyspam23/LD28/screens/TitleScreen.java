...
public class TitleScreen extends AbstractScreen{
	...
	public static final String WIN_TEXT = "Go With The Flow";
	public static final String THANKS_TEXT = "Press Any Key To Continue";
	...
	public TitleScreen(LD28Game g, SpriteBatch b, TextureRegion background, BitmapFont font) {
		super(g, b);
	...
	public void render(float delta) {
		...
		if(Gdx.input.isKeyPressed(Keys.ANY_KEY))
			game.changeScreen(new GameScreen(game, batch, 0));
	}
